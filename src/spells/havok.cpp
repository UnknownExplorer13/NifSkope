...
public:
	...
	QModelIndex cast( NifModel * nif, const QModelIndex & index ) override final
	{
		...
		spnRadius->setValue( 0.005 );
		vbox->addWidget( spnRadius );

		vbox->addWidget( new QLabel( Spell::tr( "Material" ) ) );

		// It's ugly as hell but it works
		// Can probably find a way to get the values from nif.xml at a later date instead of doing this
		QStringList matNames = { "SKY_HAV_MAT_NONE", "SKY_HAV_MAT_BROKEN_STONE", "SKY_HAV_MAT_MATERIAL_CARRIAGE_WHEEL", "SKY_HAV_MAT_MATERIAL_METAL_LIGHT",
								 "SKY_HAV_MAT_LIGHT_WOOD", "SKY_HAV_MAT_SNOW", "SKY_HAV_MAT_GRAVEL", "SKY_HAV_MAT_MATERIAL_CHAIN_METAL", "SKY_HAV_MAT_BOTTLE",
								 "SKY_HAV_MAT_WOOD", "SKY_HAV_MAT_SKIN", "SKY_HAV_MAT_UNKNOWN_617099282", "SKY_HAV_MAT_BARREL", "SKY_HAV_MAT_MATERIAL_CERAMIC_MEDIUM",
								 "SKY_HAV_MAT_MATERIAL_BASKET", "SKY_HAV_MAT_ICE", "SKY_HAV_MAT_STAIRS_GLASS", "SKY_HAV_MAT_STAIRS_STONE", "SKY_HAV_MAT_WATER",
								 "SKY_HAV_MAT_UNKNOWN_1028101969", "SKY_HAV_MAT_MATERIAL_BLADE_1HAND", "SKY_HAV_MAT_MATERIAL_BOOK", "SKY_HAV_MAT_MATERIAL_CARPET",
								 "SKY_HAV_MAT_SOLID_METAL", "SKY_HAV_MAT_MATERIAL_AXE_1HAND", "SKY_HAV_MAT_UNKNOWN_1440721808", "SKY_HAV_MAT_STAIRS_WOOD",
								 "SKY_HAV_MAT_MUD", "SKY_HAV_MAT_MATERIAL_BOULDER_SMALL", "SKY_HAV_MAT_STAIRS_SNOW", "SKY_HAV_MAT_HEAVY_STONE",
								 "SKY_HAV_MAT_UNKNOWN_1574477864", "SKY_HAV_MAT_UNKNOWN_1591009235", "SKY_HAV_MAT_MATERIAL_BOWS_STAVES",
								 "SKY_HAV_MAT_MATERIAL_WOOD_AS_STAIRS", "SKY_HAV_MAT_GRASS", "SKY_HAV_MAT_MATERIAL_BOULDER_LARGE", "SKY_HAV_MAT_MATERIAL_STONE_AS_STAIRS",
								 "SKY_HAV_MAT_MATERIAL_BLADE_2HAND", "SKY_HAV_MAT_MATERIAL_BOTTLE_SMALL", "SKY_HAV_MAT_SAND", "SKY_HAV_MAT_HEAVY_METAL",
								 "SKY_HAV_MAT_UNKNOWN_2290050264", "SKY_HAV_MAT_DRAGON", "SKY_HAV_MAT_MATERIAL_BLADE_1HAND_SMALL", "SKY_HAV_MAT_MATERIAL_SKIN_SMALL",
								 "SKY_HAV_MAT_MATERIAL_POTS_PANS", "SKY_HAV_MAT_STAIRS_BROKEN_STONE", "SKY_HAV_MAT_MATERIAL_SKIN_LARGE", "SKY_HAV_MAT_ORGANIC",
								 "SKY_HAV_MAT_MATERIAL_BONE", "SKY_HAV_MAT_HEAVY_WOOD", "SKY_HAV_MAT_MATERIAL_CHAIN", "SKY_HAV_MAT_DIRT",
								 "SKY_HAV_MAT_MATERIAL_SKIN_METAL_LARGE", "SKY_HAV_MAT_MATERIAL_ARMOR_LIGHT", "SKY_HAV_MAT_MATERIAL_SHIELD_LIGHT",
								 "SKY_HAV_MAT_MATERIAL_COIN", "SKY_HAV_MAT_MATERIAL_SHIELD_HEAVY", "SKY_HAV_MAT_MATERIAL_ARMOR_HEAVY", "SKY_HAV_MAT_MATERIAL_ARROW",
								 "SKY_HAV_MAT_GLASS", "SKY_HAV_MAT_STONE", "SKY_HAV_MAT_MATERIAL_WATER_PUDDLE", "SKY_HAV_MAT_CLOTH",
								 "SKY_HAV_MAT_MATERIAL_SKIN_METAL_SMALL", "SKY_HAV_MAT_WARD", "SKY_HAV_MAT_WEB", "SKY_HAV_MAT_MATERIAL_BLUNT_2HAND",
								 "SKY_HAV_MAT_UNKNOWN_4239621792", "SKY_HAV_MAT_MATERIAL_BOULDER_MEDIUM", "SKY_HAV_MAT_UNKNOWN_2794252627",
								 "SKY_HAV_MAT_UNKNOWN_1668849266", "SKY_HAV_MAT_UNKNOWN_1734341287", "SKY_HAV_MAT_UNKNOWN_3974071006",
								 "SKY_HAV_MAT_UNKNOWN_3941234649", "SKY_HAV_MAT_UNKNOWN_1820198263"
								};
		QList<int unsigned long long> matValues = { 0, 131151687, 322207473, 346811165, 365420259, 398949039, 428587608, 438912228, 493553910, 500811281, 591247106,
													617099282, 732141076, 781661019, 790784366, 873356572, 880200008, 899511101, 1024582599, 1028101969, 1060167844,
													1264672850, 1286705471, 1288358971, 1305674443, 1440721808, 1461712277, 1486385281, 1550912982, 1560365355,
													1570821952, 1574477864, 1591009235, 1607128641, 1803571212, 1848600814, 1885326971, 1886078335, 2022742644,
													2025794648, 2168343821, 2229413539, 2290050264, 2518321175, 2617944780, 2632367422, 2742858142, 2892392795,
													2965929619, 2974920155, 3049421844, 3070783559, 3074114406, 3106094762, 3387452107, 3424720541, 3448167928,
													3589100606, 3702389584, 3708432437, 3725505938, 3739830338, 3741512247, 3764646153, 3839073443, 3855001958,
													3895166727, 3934839107, 3969592277, 4239621792, 4283869410, 2794252627, 1668849266, 1734341287, 3974071006,
													3941234649, 1820198263
												};
		QComboBox * cmbOptions = new QComboBox;
		cmbOptions->setEditable( true );
		cmbOptions->addItems( matNames );
		vbox->addWidget( cmbOptions );
		...
		/* set CVS material */
		int mat = matValues.at( cmbOptions->currentIndex() );
		nif->set<int>( iCVS, "Material", mat );
